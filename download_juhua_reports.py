...
"""
下载巨化股份3年一期的报告
(2024年年报、2023年年报、2022年年报、2025年上半年报)
"""
...
SAVE_DIR = os.path.join(os.path.dirname(__file__), "annual_reports", "600160_巨化股份")
...
# 查询三种报告类型
report_types = [
    ("category_ndbg_szsh", "年报", [2024, 2023, 2022]),
        ...
        try:
            ...
            for ann in announcements:
                ...
                if adjunct_url:
                    ...
                    # 生成文件名
                    if report_name == "年报":
                        filename = f"600160_巨化股份_{year}年年度报告.pdf"
                    else:  # 半年报
                        filename = f"600160_巨化股份_{year}年上半年度报告.pdf"
...
for i, report in enumerate(all_reports, 1):
    ...
    if download_pdf(report["url"], report["filename"]):
        success_count += 1
    time.sleep(1)

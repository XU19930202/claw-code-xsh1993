#!/usr/bin/env python3
"""
回测000506在中润资源/招金黄金期间(2025.6.27-现在)使用主板策略
"""
import sys
sys.path.insert(0, '.')
...
print('=' * 85)
print(f'  MA20突破回踩策略 v5 - 股票回测 (主板策略)')
print('=' * 85)
print(f'\n股票代码: {ts_code}')
print(f'回测期间: 2025-06-27 ~ 现在 (中润资源/招金黄金期间)')
...
# 获取换手率数据
try:
    daily_basic = pro.daily_basic(ts_code=ts_code, start_date=start_str, end_date=end_str)
...
# 强制使用主板策略（非ST）
stock_name = '招金黄金'
print(f'股票名称: {stock_name} (强制使用主板参数)')
